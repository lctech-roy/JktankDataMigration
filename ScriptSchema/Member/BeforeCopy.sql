ALTER TABLE "MemberProfile"
    DROP CONSTRAINT IF EXISTS "FK_MemberProfile_Member_Id";
ALTER TABLE "Blog"
...
ALTER TABLE "MemberRelation"
    DROP CONSTRAINT IF EXISTS "FK_MemberRelation_Member_RelatedMemberId",
    DROP CONSTRAINT IF EXISTS "FK_MemberRelation_Member_Id";
...
ALTER TABLE "MemberTimeline"
    DROP CONSTRAINT IF EXISTS "FK_MemberTimeline_Member_CreatorId";
ALTER TABLE "MemberTopic"
    DROP CONSTRAINT IF EXISTS "FK_MemberTopic_Member_Id";     
